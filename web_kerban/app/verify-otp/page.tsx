    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-20">
      <div className="glass-card p-8 w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          <i className="bi bi-shield-check text-4xl text-primary-600 dark:text-primary-400" />
        ...
        {resendMsg && (
          <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 text-green-600 dark:text-green-400 text-sm rounded-xl p-3 mb-6">
            {resendMsg}
          </div>
        )}
        ...
        <div className="flex justify-center gap-2 mb-6" onPaste={handlePaste}>
          {otp.map((digit, i) => (
            <input
              ...
              className={cn(
                "w-12 h-14 text-center text-xl font-bold rounded-xl border-2 border-border bg-background",
        ...
        {loading && (
          <div className="flex justify-center mb-4">
            <span className="loader-spinner w-5 h-5 border-2" />
          </div>
        )}
        ...
        <button
          onClick={resendOtp}
          disabled={resending}
          className="w-full text-sm text-muted-foreground hover:text-primary-600 dark:hover:text-primary-400 transition-colors py-2"
        >
